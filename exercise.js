...
console.log(x + " is the longest place name in the world and has " + y + " letters in its name."); //Taumatawhakatangihangakoauauotamateaturipukakapiki- maungahoronukupokaiwhenuakitanatahu is the longest place name in the world and has 87 letters in its name.
...
var indexAre = edward.indexOf('are');
console.log(indexAre); //7
var indexEnd = edward.indexOf('of');
console.log(indexEnd); //18
var scissorHand = edward.slice(7, 18);
console.log(scissorHand); //are afraid
...
console.log(theSifu); //In order to taste my cup of water you must first empty your cup.
...
console.log(smallKine); //bruuhhhh, i am da greatest!
...
console.log(bigBand); //THE BEATLES
...
var indexGin = drinkMenu.indexOf('gin');
var indexVodka = drinkMenu.indexOf('vodka');
var ginVodka = indexVodka - indexGin - 2;
console.log(indexGin); //5
console.log(indexVodka); //10
console.log(ginVodka); //3
var favDrink = drinkMenu.substr(5, 3);
console.log(favDrink); //gin